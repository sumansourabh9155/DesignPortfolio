			...
			<div class="container flex flex-col px-5 py-4 mx-auto  md:py-16 md:flex-row md:items-center scroll-smooth">
				...
				<div class="flex flex-col items-center w-full md:flex-row md:w-1/2">
					<div class="max-w-lg md:mx-12 md:order-2">
						<p class="leading-relaxed opacity-50 ">About Me </p>
						<h1 class="title-font tracking-wide sm:text-xl md:text-2xl xl:text-4xl  font-bold ">
							Suman Sourabh
						</h1>
						...
						<div class="mt-6">
							<a
								href="#_"
								class="px-4 py-2 text-xs font-bold text-white uppercase transition-all duration-150 bg-black rounded shadow outline-none active:bg-teal-600 hover:shadow-md focus:outline-none ease"
							>
								Sign Up
							</a>
						</div>
					...
					<div class="flex justify-center order-2 mt-6 md:mt-0 md:space-y-3 md:flex-col">
						<button class="w-3 h-3 mx-2 bg-black rounded-full md:mx-0 focus:outline-none"></button>
						<button class="w-3 h-3 mx-2 bg-gray-300 rounded-full md:mx-0 focus:outline-none hover:bg-black"></button>
						<button class="w-3 h-3 mx-2 bg-gray-300 rounded-full md:mx-0 focus:outline-none hover:bg-black"></button>
						<button class="w-3 h-3 mx-2 bg-gray-300 rounded-full md:mx-0 focus:outline-none hover:black"></button>
					</div>
				</div>
			</div>
